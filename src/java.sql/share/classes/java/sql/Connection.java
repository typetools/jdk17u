...
public interface Connection  extends Wrapper, AutoCloseable {
     ...
     * or this method is called on a closed connection
     */
    PreparedStatement prepareStatement(@SqlEvenQuotes String sql)
        throws SQLException;
     ...
     * @since 1.2
     */
    PreparedStatement prepareStatement(@SqlEvenQuotes String sql, int resultSetType,
     ...
     * @since 1.2
     */
    CallableStatement prepareCall(@SqlEvenQuotes String sql, int resultSetType,
     ...
     * @since 1.4
     */
    PreparedStatement prepareStatement(@SqlEvenQuotes String sql, int autoGeneratedKeys)
        throws SQLException;
     ...
     * @since 1.4
     */
    PreparedStatement prepareStatement(@SqlEvenQuotes String sql, int columnIndexes[])
        throws SQLException;
     ...
     * @since 1.4
     */
    PreparedStatement prepareStatement(@SqlEvenQuotes String sql, String columnNames[])
        throws SQLException;
