...
public interface Statement extends Wrapper, AutoCloseable {
  ...
  //--------------------------JDBC 3.0-----------------------------
   ...
   /**
     ...
     * @since 1.8
     */
    default long executeLargeUpdate(@Untainted @SqlEvenQuotes String sql, int autoGeneratedKeys)
            throws SQLException {
     ...
     * @since 1.8
     */
    default long executeLargeUpdate(@Untainted @SqlEvenQuotes String sql, String columnNames[])
            throws SQLException {
        throw new SQLFeatureNotSupportedException("executeLargeUpdate not implemented");
    }
